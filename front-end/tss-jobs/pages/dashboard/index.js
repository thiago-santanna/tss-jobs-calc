...
const Dashboard = () => {
  return (
    <>
      <NavBarComponent />
      <div className="bg-gray-800 text-white border-t border-gray-200 h-32">
        <div className="container mx-auto">
          <div className="flex flex-row flex-wrap space-x-3 justify-between p-2 items-end">
            <div>
              <p>12</p>
      ...
      <div className="container mx-auto -m-8">
        <div className="bg-slate-100 flex flex-col md:flex-row space-x-4 justify-between items-center p-4 rounded-md mb-4">
          <div>
            <span className="mx-4 text-slate-400 ">1</span>
          ...
          <div className="bg-green-200 rounded-3xl w-40 max-w-xs text-center py-1">
        ...
        <div className="bg-slate-100 flex flex-col md:flex-row space-x-4 justify-between items-center p-4 rounded-md mb-4">
          ...
          <div className="bg-red-200 rounded-3xl w-40 max-w-xs text-center py-1">
